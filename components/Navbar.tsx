...
const Navbar = ({signIn = true, signUp = true}) => {
  return (
    <Box position="static" sx={{position:"absolute", marginBottom:"0", p:0,flexDirection:"row", display:"flex", alignItems:"center", backgroundColor:"transparent", width:"90vw", justifyContent:"space-between"}}>
        <Box sx={{flex:1}}>
