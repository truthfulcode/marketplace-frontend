    ...
    <Box sx={{ 
      ...
      <Box sx={{...styles.center}}>
        <Box sx={{display:"grid", gridTemplateColumns:"repeat( auto-fit, minmax(300px, 1fr) );", marginTop:"50px;", width:"50vw", minHeight:"600px", height:"auto", marginLeft:"0"}}>
          <Box sx={{...styles.listingBox, border:"2px solid black"}}><a href="#"><Box sx={{...styles.center}}><TitleText style={{marginLeft:"10px", marginTop:"5px", fontSize: "15pt"}}>Customer Name:</TitleText></Box><p style={{textAlign:"center", marginTop:"-21px"}}>Lorem ipsum dolor, sit amet consectetur adipisicing.</p><Box sx={{...styles.center}}><TitleText style={{marginLeft:"10px", marginTop:"5px", fontSize: "15pt"}}>Order Tittle</TitleText></Box><p style={{textAlign:"center", marginTop:"-21px"}}>Lorem ipsum dolor, sit amet consectetur adipisicing.</p><Box sx={{...styles.center}}><TitleText style={{marginLeft:"10px", marginTop:"5px", fontSize: "15pt"}}>Description</TitleText></Box><p style={{textAlign:"center", marginTop:"-21px"}}>Lorem ipsum dolor, sit amet consectetur adipisicing.</p><Box sx={{...styles.center, marginBottom:"0", height:"50px", borderTop:"1px solid black"}}><TitleText style={{marginLeft:"5px", fontSize:"10pt", marginBottom:"-15px"}}>$45</TitleText></Box></a></Box>
          <Box sx={{...styles.listingBox, border:"2px solid black"}}><a href="#"><Box sx={{...styles.center}}><TitleText style={{marginLeft:"10px", marginTop:"5px", fontSize: "15pt"}}>Customer Name:</TitleText></Box><p style={{textAlign:"center", marginTop:"-21px"}}>Lorem ipsum dolor, sit amet consectetur adipisicing.</p><Box sx={{...styles.center}}><TitleText style={{marginLeft:"10px", marginTop:"5px", fontSize: "15pt"}}>Order Tittle</TitleText></Box><p style={{textAlign:"center", marginTop:"-21px"}}>Lorem ipsum dolor, sit amet consectetur adipisicing.</p><Box sx={{...styles.center}}><TitleText style={{marginLeft:"10px", marginTop:"5px", fontSize: "15pt"}}>Description</TitleText></Box><p style={{textAlign:"center", marginTop:"-21px"}}>Lorem ipsum dolor, sit amet consectetur adipisicing.</p><Box sx={{...styles.center, marginBottom:"0", height:"50px", borderTop:"1px solid black"}}><TitleText style={{marginLeft:"5px", fontSize:"10pt", marginBottom:"-15px"}}>$45</TitleText></Box></a></Box>
          <Box sx={{...styles.listingBox, border:"2px solid black"}}><a href="#"><Box sx={{...styles.center}}><TitleText style={{marginLeft:"10px", marginTop:"5px", fontSize: "15pt"}}>Customer Name:</TitleText></Box><p style={{textAlign:"center", marginTop:"-21px"}}>Lorem ipsum dolor, sit amet consectetur adipisicing.</p><Box sx={{...styles.center}}><TitleText style={{marginLeft:"10px", marginTop:"5px", fontSize: "15pt"}}>Order Tittle</TitleText></Box><p style={{textAlign:"center", marginTop:"-21px"}}>Lorem ipsum dolor, sit amet consectetur adipisicing.</p><Box sx={{...styles.center}}><TitleText style={{marginLeft:"10px", marginTop:"5px", fontSize: "15pt"}}>Description</TitleText></Box><p style={{textAlign:"center", marginTop:"-21px"}}>Lorem ipsum dolor, sit amet consectetur adipisicing.</p><Box sx={{...styles.center, marginBottom:"0", height:"50px", borderTop:"1px solid black"}}><TitleText style={{marginLeft:"5px", fontSize:"10pt", marginBottom:"-15px"}}>$45</TitleText></Box></a></Box>
          <Box sx={{...styles.listingBox, border:"2px solid black"}}><a href="#"><Box sx={{...styles.center}}><TitleText style={{marginLeft:"10px", marginTop:"5px", fontSize: "15pt"}}>Customer Name:</TitleText></Box><p style={{textAlign:"center", marginTop:"-21px"}}>Lorem ipsum dolor, sit amet consectetur adipisicing.</p><Box sx={{...styles.center}}><TitleText style={{marginLeft:"10px", marginTop:"5px", fontSize: "15pt"}}>Order Tittle</TitleText></Box><p style={{textAlign:"center", marginTop:"-21px"}}>Lorem ipsum dolor, sit amet consectetur adipisicing.</p><Box sx={{...styles.center}}><TitleText style={{marginLeft:"10px", marginTop:"5px", fontSize: "15pt"}}>Description</TitleText></Box><p style={{textAlign:"center", marginTop:"-21px"}}>Lorem ipsum dolor, sit amet consectetur adipisicing.</p><Box sx={{...styles.center, marginBottom:"0", height:"50px", borderTop:"1px solid black"}}><TitleText style={{marginLeft:"5px", fontSize:"10pt", marginBottom:"-15px"}}>$45</TitleText></Box></a></Box>
        </Box>
