          ...
          {accountType === "FREELANCER" ? (
            <>
              <Typography fontSize={32}>
                Looking for work? <br /> Weve got your back.
              </Typography>
              <TextField
                inputProps={{
                  style: {
            ...
            <Typography fontSize={32}>
              Looking for a freelancer? <br /> Weve got your back.
            </Typography>
          )}
        </Box>
      </Box>
      <Box p={2}>
        <TitleText>POPULAR CATEGORIES</TitleText>
        <Grid container spacing={2}>
          {[
            ...
            <Grid
              item
              sx={{ flexDirection: "column", ...styles.center }}
              key={index}
              xs={4}
            >
              <Box
                sx={{ border: "2px solid black", borderRadius: 16, p: 2, m: 1 }}
              >
                <Image
                  width={40}
                  height={40}
                  alt="category image"
                  src={
                    "/img/landing-categories/landingCategory" +
                    index.toString() +
                    ".png"
                  }
                />
              </Box>
              <CategoryText fontSize={24} sx={styles.textCenter}>
                {value}
              </CategoryText>
            </Grid>
          ))}
